...
| **17a** | T-W3-02 | `apps/{reporter,control-center,subscriber}/web/manifest.json`+SW 등록 확장(신규, E2 §C 예상 경로 참조) — 단독(**D4-5, V-7 — 02§E-10 순서 선언에 따라 T-W3-03의 선행으로 분리**, EVAL-ROUND-4 영역4 감점1 정정. 舊 Wave 17은 3건 병렬로 이 순서를 근거 기록 없이 평탄화했었다) | M(6파일) | Wave 16 |
