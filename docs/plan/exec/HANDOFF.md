...
| 항목 | 값 | 재현 |
|---|---|---|
| main | `e490130` (PR #78) | `git fetch origin main && git log --oneline -1 origin/main` (§7-0 — 로컬 ref는 stale일 수 있다) |
...
| T-W3-02 | 3앱 PWA manifest + SW 배선 확장 | T-W1-04 기반 존재. ⚠️ 착수 시 대장 **#142** 재현 명령(`ls apps/subscriber/web/manifest.json`)이 파일 부재로 불성립 상태 — 이 태스크가 그 파일을 만들면 함께 정정 |
...
**후보 밖 12건의 내역**(미착수 19 − 후보 7, 2026-08-28 명시): §4 착수 금지 **7건**
