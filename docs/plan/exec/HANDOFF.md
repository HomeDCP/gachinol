...
| 대장에 **#173~#189(17건)** 채번 | `../PIVOT-PLAN.md` §6-11 |
...
### 다음 1건
**QUEUE 0-1 · 대장 #186 — 빌드 스탬프 + 배포 후 SHA 대조.**
이게 없으면 이후 모든 수리의 *"고쳤다"*가 자기 신고다. 선행·차단자 없음.
⚠️ 단 **사용자가 "계획을 더 다듬는다"를 택해(2026-08-31) 개발 착수는 보류 중**이다.
