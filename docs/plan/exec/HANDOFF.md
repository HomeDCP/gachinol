...
### ⭐⭐⭐⭐ 지금의 다음 1건 (2026-09-13, scribe 갱신 — "업로드 경로 복구" 슬라이스 종료: PR #102·#103 머지 대기)
...
- **대장 #216·#217·#218·#219·#220·#221**(2026-09-13 "업로드 경로 복구" 슬라이스가 드러낸 6건, 전부
  등재만) — 상세는 위 "⭐⭐⭐⭐ 지금의 다음 1건" 절 및 PIVOT-PLAN 대장 해당 행. QUEUE 편입 여부·순서
  전부 판정 대기.
- **대장 #211·#212·#213**(수리 완료·PR 대기) — 각자의 수동 해소 판정(위 "다음 1건" 참조)이 다음
  세션의 실질 착수 대상이다. **대장 #169**는 재생·썸네일 축만 부분 해소(업로드 축은 #211 잔존),
  **대장 #214**는 해소 완료(위 참조).
...
④ **PR #102·#103 머지**(2026-09-13 요청 — 대장 #213·#212·#211, "업로드 경로 복구" 슬라이스) — 순서대로
(스택 PR: #103의 base가 #102). 머지 = 자동 배포(QUEUE §D-1 승인 게이트 통과 필요).
⑤ **C-7(MinIO 라이프사이클 규칙)**(QUEUE §C, 대장 #219, 2026-09-13 채번) — 요청 시점은 지금이 아니라
**#103 머지 직전**(리드타임 반영, 지금은 고아 0건·1.8T 여유라 급하지 않다).
